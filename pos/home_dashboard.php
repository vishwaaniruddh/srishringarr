                                      ...
                                      <div class="row">
                                        <div class="col-12">
            								  <div class="table-responsive">
            								      <?php
            								    //   echo "SELECT * FROM `phppos_rent` where  (booking_status='Booked') order by pick_date ASC" ; 
            								      ?>
            									<table id="order-listing" class="table">
            									  ...
            									  <tbody>
            									      <?php 
                                                        ...
                                                        <tr>
                                                        <td><a href="reports/rent_report_detail.php?id=<?php echo $bill11[0]; ?>" target="_blank"><?php echo $new_bill_number ? $new_bill_number : $bill11[0]; ?></a></td>
                                                        <td><?php echo $r2[7]; ?></td>
