    ...
    $mode= $_POST['pay_By'];
      $cardperc="0";
	    if(isset($_POST['pay_By'])){
	        if($_POST['pay_By']=="Card" || $_POST['pay_By']=="SAK-Card"){
	           $cardperc="2"; 
	        }
	         if($_POST['pay_By']=="Bank" || $_POST['pay_By']=="SAK-Bank"){
	           $cardperc="1"; 
	        }
	    }
...
$t1=mysqli_query($con,"insert into `phppos_rent`(cust_id,bill_date,status,pick,delivery,throught,pstatus,bal_amount,pick_date,delivery_date,delivery_status,trail_date,measurement,measurement_note,is_delivery,throught_phone,person_Name,person_contact,comm_by,comm_amount,note,booking_status,card_perc,card_amt,bill_madeby,company_name,payment_mode_name) 
...
'".$_POST['cardpercamt']."', '".$bill_madeby."','".$company_name."','".$mode."' )  ");
