...
function formSubmit() {
    if (document.getElementById('cid').value == "-1") {
        ...
        if (company === "SAKAR TRADE LINK") {
            form.action = "sakar.php";
        } else if (company === "Sri Shringarr") {
            form.action = "ssfs.php";
        } else {
...
<td width="1308"  valign="top"><center>
      ...
      <form name="listForm" method="POST" id="frm1">
       ...
       <tr>
<td height="36"><strong>Customer Pick-Up :</strong></td>
<td> <input name="pick" id="pick" type="radio" value="Customer"></td>
<td><strong>Customer Pick-Up Date :</strong><input type="text" name="cust_pick" id="cust_pick" onClick="displayDatePicker('cust_pick');" autocomplete="nope"/></td>  
<td> <strong>Company Delivery :</strong></td>
<td><input name="pick" id="del2" type="radio" value="Company Delivery" ></td>
<td ><strong>Company Delivery Date: </strong><input type="text" name="comdel_date" id="comdel_date" onClick="displayDatePicker('comdel_date');" autocomplete="nope"/></td>
       </tr>
...
<td><strong>Company Pick-Up :</strong></td>
<td><input name="del" id="pick2" type="radio" value="Company Pickup"></td>
<td><strong>Company Pick-Up Date :</strong><input type="text" name="compick_date" id="compick_date"  onClick="displayDatePicker('compick_date');" autocomplete="nope"/></td>
      ...
      <tr>
      <td height="34"><strong>Customer Name:&nbsp;</strong></td>
      <td>
...
<input type="hidden" name="cid" id="cid" />
	 ...
	 <td><strong>2nd Person's Name:</strong></td><td><input type="text" name="pname" id="pname" />  <input type="hidden" name="myvar" value="0" id="theValue" /></td>
     <td><strong>Through Name:</strong></td>
     <td>
    ...
    <tr>
    <td height="35" ><strong>Bill  Date :</strong></td><td><input type="text" name="bill_date" id="bill_date" onClick="displayDatePicker('bill_date');"/></td>
  ...
  <td colspan="11"><div id="detail"></div></td>
      ...
      <table width="1240" height="29" border="1" cellspacing="0">
      <tr>
      ...
      <td width="173">
        ...
        <td><strong>In Account :</strong></td>
       ...
       while($row=mysqli_fetch_row($qryitem))
		 {
			...
			<td width="90"><strong>Payment By :</strong> </td>
			<td width="173">
                <p style="white-space: nowrap;padding: 0;margin: 0;"><input name="pay_By" type="radio" value="Bank" onchange="checkTotal()">
                <strong>SS-Bank</strong><br></p>
                
                <p style="white-space: nowrap;padding: 0;margin: 0;"><input name="pay_By" type="radio" value="Cash" onchange="checkTotal()">
                <strong>SS-Cash</strong></p>
                <p style="white-space: nowrap;padding: 0;margin: 0;">
                    <input name="pay_By" type="radio" value="Card" onchange="checkTotal()">
                    <strong>SS-Card</strong>                    
                </p>
                
                <p style="white-space: nowrap;padding: 0;margin: 0;"><input name="pay_By" type="radio" value="SAK-Bank" onchange="checkTotal()">
                <strong>SAK-Bank</strong><br></p>
                
                <p style="white-space: nowrap;padding: 0;margin: 0;"><input name="pay_By" type="radio" value="SAK-Cash" onchange="checkTotal()">
                <strong>SAK-Cash</strong></p>
                <p style="white-space: nowrap;padding: 0;margin: 0;">
                    <input name="pay_By" type="radio" value="SAK-Card" onchange="checkTotal()">
                    <strong>SAK-Card</strong>                    
                </p>
        ...
        <tr><td><strong>Trail Date :</strong></td>
          <td><input type="text" name="trail_date" id="trail_date"   onClick="displayDatePicker('trail_date');" autocomplete="nope"/></td> 
