...
$future_qry = "SELECT a.*, b.pick_date as rentpickdate, b.delivery_date as rentdeliverydate,b.new_bill_number FROM `order_detail` a 
        ...
        <table border="1">
            ...
            ?>
                <tr align="center">
                    ...
                    <td style="font-size:12px;border:1px solid black;"><?php echo $new_bill_number ? $new_bill_number : $row[0] ; ?></td>
                    ...
                    <td style="font-size:12px;border:1px solid black;white-space:nowrap;">
                        ...
                        if($resrent[3]=='0000-00-00'){
                            ...
                            echo  date('d-m-Y', strtotime($resrent[3])); 
                        }
