...
<td width="1308"  valign="top"><center>
    ...
    <div align="center" style="color:#03F"> Filter By Date : From <input type="text" id='frmdate' name="frmdate" onClick="displayDatePicker('frmdate')"> &nbsp To : <input type="text" id='todate' name="todate" onClick="displayDatePicker('todate')">&nbsp Invoice Number : <input type="text" id='invno' name="invno" ">
