...
<div class="row">
    <div class="col-sm-6">
            ...
            <img src="../yn/uploads<?php echo $prcdrws[0]; ?>" style="    border-radius: 100%; height: 150px;width: 150px;object-fit: scale-down;" />
    ...
    <h3 style="color:#d1b754">Edit Product</h3>
        Product Code:   <input type="text" name="code" id="code" onKeyUp="lookup2(this.value,this.id,'centersuggestions','centerautoSuggestionsList','centerref1');" class="form-control" value="<?php echo $row[2]; ?>" onBlur="hidediv()" readonly="" />
