...
<script src="dist/dropzone.js"></script>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            ?>
            <h3 style="background:white;padding:15px;text-align:center;">Web Banner</h3>
            
            <hr>

    <form action="add_banner.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" class="form-control">
        <input type="hidden" name="bannerfor" value="1" class="form-control">
        <br>
...
<div class="row">
    <?
    $sql = mysqli_query($con,"select * from bannerimg where bannerfor=1 and status=1");
    ...
    ?>
            <div class="col-sm-6">    
                <div class="bannerdiv" style="padding:10px;border:1px solid  #e48b8b;">
                    <img src="<? echo 'banner/web/'.$image; ?>" style="width:100%;">
                    <br><br>
                    <a class="btn btn-danger" href="deleteban.php?bannerfor=1&id=<? echo $id; ?>">Delete</a>                    
                </div>
