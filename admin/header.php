...
<head>
  ...
  <title>Srishringarr Admin</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.php"><img src="./assets/main_logo.png" class="mr-2" alt="logo" style="height:46px;"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.php"><img src="./assets/main_logo.png" alt="logo"/></a>
      </div>
