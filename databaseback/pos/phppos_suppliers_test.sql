...
--
-- Table structure for table `phppos_suppliers_test`
--

DROP TABLE IF EXISTS `phppos_suppliers_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `phppos_suppliers_test` (
  `person_id` int(10) NOT NULL,
  `company_name` varchar(255) NOT NULL,
  `account_number` varchar(255) DEFAULT NULL,
  UNIQUE KEY `account_number` (`account_number`),
  KEY `person_id` (`person_id`),
  CONSTRAINT `phppos_suppliers_test_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `phppos_people_test_old` (`person_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `phppos_suppliers_test`
--

LOCK TABLES `phppos_suppliers_test` WRITE;
/*!40000 ALTER TABLE `phppos_suppliers_test` DISABLE KEYS */;
INSERT INTO `phppos_suppliers_test` VALUES
(1,'Prakesh Bhai','PB'),
(2,'Sia','S'),
(3,'Bhavin Bhai','BH'),
(4,'Lalitji',NULL),
...
(143568,'ram traders',NULL),
(143559,'karunamai traders','KMT'),
(2687,'Na','na'),
(143559,'rajesh','isns');
/*!40000 ALTER TABLE `phppos_suppliers_test` ENABLE KEYS */;
UNLOCK TABLES;
