...
--
-- Table structure for table `garment_product_client`
--

DROP TABLE IF EXISTS `garment_product_client`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `garment_product_client` (
...
--
-- Dumping data for table `garment_product_client`
--

LOCK TABLES `garment_product_client` WRITE;
/*!40000 ALTER TABLE `garment_product_client` DISABLE KEYS */;
/*!40000 ALTER TABLE `garment_product_client` ENABLE KEYS */;
UNLOCK TABLES;
