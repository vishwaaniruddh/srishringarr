  ...
  <table class="table" border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="center"><?php echo $i++; ?></td>
       <td align="left"><a href="jewelpro.php?cid=<?php echo $row[1]; ?>&sid=<?php echo $row[0]; ?>">
       <img src="images/folder.gif"  style="height: auto; width: auto;">&nbsp;<?php echo strtoupper($row[2]); ?></a></td>
        <td><?php echo $row[4] ?></td>
        <td align="left">
            <a href="newproduct.php?cid=<?php echo $cid; ?>&sid=<?php echo $row[0]; ?>">Add Product</a>
            <a href="upload_data.php?cid=<?php echo $cid; ?>&sid=<?php echo $row[0]; ?>&type=1"> / Upload Product</a>       
       </td>
  ...
  <form id="form1" name="form1" method="post"  action="process_subcat.php" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-12">
          ...
          <b><u><?php echo $row1[2]; ?></u></b> <input type="hidden" name="cid" id="cid"  value="<?php echo $row1[0]; ?>"/>
        </div>
