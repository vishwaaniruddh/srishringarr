...
<div>
    <a href="<?php echo "../../uploads".$getpimgsrws[0]; ?>" target="_new" title="Product Code: <?php echo $code;?>">  
    <img src='<?php echo "../../uploads".$getpimgsrws[0]; ?>' style="    height: 200px; width: 200px;object-fit: contain;"></a>    
</div>
