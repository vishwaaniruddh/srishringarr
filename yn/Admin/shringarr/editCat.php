...
$sql=mysqli_query($con,"select * from jewel_subcat where `subcat_id`=$id");
	
	$row=mysqli_fetch_array($sql);
		?>
        

<form id="form1" name="form1" method="post"  action="processEdit_category.php" enctype="multipart/form-data">
 ...
 <td colspan="2"><h3 style="color:#d1b754">New Category</h3></td></tr>
  ...
  <td height="82">Category Description :</td>
      ...
      <tr>
          ...
          <td width="361">
          <img src="../<?php echo $row[5]; ?>" width="88" height="93" />
